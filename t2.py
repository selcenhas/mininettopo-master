...
def topology():
    ...
    h1=net.addHost('h1',mac='00:00:00:00:00:21',ip="10.0.0.2/8")
    h2=net.addHost('h2',mac='00:00:00:00:00:22',ip="10.0.0.5/8")
    ...
    net.addLink(s11,h2,**linktohosts)
    net.addLink(s11,h3,**linktohosts)
    net.addLink(s11,h2,**linktohosts)
    ...
    net.addLink(s19,h2,**linktohosts)
